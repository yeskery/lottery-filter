...
import com.yeskery.filter.PostionFilter;
...
public class FiveStarTest {
	...
	public static void main(String[] args) {
		...
		filterChain.add(new PostionFilter(5, 1, true, 1, 2, 3));
		filterChain.add(new PostionFilter(5, 2, true, 3, 4, 5));
		filterChain.add(new PostionFilter(5, 3, true, 2, 3, 4));
		...
		filterChain.add(new PostionFilter(5, 1, false, 3, 4, 5));
		filterChain.add(new PostionFilter(5, 2, false, 3, 4, 5));
		filterChain.add(new PostionFilter(5, 3, false, 1, 2, 3));
		filterChain.add(new PostionFilter(5, 5, false, 4, 5, 6));
